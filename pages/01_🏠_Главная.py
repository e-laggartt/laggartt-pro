...
def load_sheets():
    ...
    # Удаляем лист "Кронштейны", если есть
    sheets.pop("Кронштейны", None)
    return sheets

sheets = load_sheets()

# Доступные подключения и типы
...
# Ключ сессии для текущей конфигурации
...
for _, row in df_sheet.iterrows():
    ...
    # Извлекаем высоту и длину из наименования: .../500/1200 мм
